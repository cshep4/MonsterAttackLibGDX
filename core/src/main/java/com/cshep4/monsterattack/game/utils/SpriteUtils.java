...
public class SpriteUtils {
    ...
    public static String getPlayerRunningSprite(float xVel, int remainingShieldTime) {
        String sprite;

        if (xVel < 0) {
            sprite = getPlayerLeftSprite(remainingShieldTime);
        } else {
            sprite = getPlayerRightSprite(remainingShieldTime);
        }
