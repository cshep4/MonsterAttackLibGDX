...
public class StandardProducerTest {
    ...
    @Test
    public void create() {
        GameObject standardProducer = StandardProducer.create(X_POS, Y_POS);

        assertThat(standardProducer, instanceOf(StandardProducer.class));
        assertThat(standardProducer.getX(), is(X_POS));
        assertThat(standardProducer.getY(), is(Y_POS));
    }
}